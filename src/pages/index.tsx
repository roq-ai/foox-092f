  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - Your Ultimate Job Marketplace. Connect with top freelancers and innovative companies ready to offer jobs. Simplifying the way work gets done."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - Your Ultimate Job Marketplace. Connect with top freelancers and innovative companies ready to offer jobs. Simplifying the way work gets done.`}
            </Text>
            <Box
